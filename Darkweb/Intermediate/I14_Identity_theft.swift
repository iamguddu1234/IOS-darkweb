            ...
            VStack(spacing: 0) {
                ScrollView {
                    VStack(alignment: .leading, spacing: 15) {
                        ...
                        Text2(title1: p3, title2: p3_desc)
                        
                        Text2(title1: p4, title2: p4_desc)
                        
                        Text2(title1: p5, title2: p5_desc)
                        
                        Text2(title1: p6, title2: p6_desc)
                        
                        Text2(title1: p7, title2: p7_desc)
                        
                        Text2(title1: p8, title2: p8_desc)
                        
                        Text2(title1: p9, title2: p9_desc)
                        
                        Stext(title: p10)
                        
                        Text2(title1: p11, title2: p11_desc)
                        
                        Text2(title1: p12, title2: p12_desc)
                        
                        Text2(title1: p13, title2: p13_desc)
                        
                        Text2(title1: p14, title2: p14_desc)
                        
                        Text2(title1: p15, title2: p15_desc)
                        
                        Text2(title1: p16, title2: p16_desc)
                        
                        Text2(title1: p17, title2: p17_desc)
                        
                        Text2(title1: p18, title2: p18_desc)
