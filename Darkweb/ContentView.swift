        ...
        NavigationView{
            ...
            VStack {
                ...
                Group {
                    ...
                    case 0:
                        BasicHomeView(showTabBar: $showTabBar)
                        
                    case 1:
                        IntermediateView(showTabBar: $showTabBar) // Pass the binding to the BasicHomeView
                        
                    case 2:
                        AdvanceView(showTabBar: $showTabBar)// Pass the binding to the BasicHomeView
